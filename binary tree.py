...
# Encode the binary tree to a string of balanced parentheses
parens = treeToParens(tree)
print(parens)  

# Decode the string of balanced parentheses back to a binary tree
decoded_tree = parensToTree(parens)
print(decoded_tree)
